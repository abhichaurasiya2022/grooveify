...
const Card: React.FC<CardProps> = ({ className, imageUrl, title, subtitle }) => {
    return (
        <div className={` ${className}  hover:scale-105 transition-transform duration-150 ease-in-out transition-shadow duration-200 ease-in-out flex bg-transparent overflow-clip  rounded-lg flex-col min-h-44 min-w-44`}>
