        ...
        <div>
            {
                setting === 'dark' ?
                    (
                        <button className='rounded-full overflow-hidden ' onClick={() => setSetting('light')}>< MoonIcon className="w-8 h-8" /> </button>
                    ) : (
                        <button onClick={() => setSetting('dark')}><SunIcon className="w-8 h-8" /></button>
                    )
            }
        </div>
